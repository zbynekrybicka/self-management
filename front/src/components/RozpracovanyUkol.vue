<template>
    <div class="rozpracovany-ukol-okno">
        <div class="row">
            ...
            <div class="col-12 col-sm-6">
                <h6 class="text-center font-weight-bold border border-primary pt-2 pb-2 cursor-pointer" @click="vyberUkol(rozpracovanyUkol)" v-html="nazev(rozpracovanyUkol) + '<br />' + casUkolu" />
            </div>
        </div>
    </div>
</template>
